...
const OverViewTab = dynamic(() => import('@/views/apps/tokoku/customers/details/customer-right/overview'))
const SecurityTab = dynamic(() => import('@/views/apps/tokoku/customers/details/customer-right/security'))
const NotificationsTab = dynamic(() => import('@/views/apps/tokoku/customers/details/customer-right/notification'))

const AddressBillingTab = dynamic(
  () => import('@/views/apps/tokoku/customers/details/customer-right/address-billing')
)
